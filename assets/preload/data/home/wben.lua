...
idle_xml_name = 'Bendy Idle instance'
left_xml_name = 'Left instance'
down_xml_name = 'bendydown instance'
up_xml_name = 'Up instance'
right_xml_name = 'B-Right instance'
...
name_of_character_xml = 'wBendy_remastered'
name_of_character = 'wben'
name_of_notetype = 'ben'
name_of_notetype2 = 'ben' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onStepHit()
	if curStep == 2756 then
		doTweenAlpha('ben',name_of_character,0.5,0.7,'linear')
	end
end